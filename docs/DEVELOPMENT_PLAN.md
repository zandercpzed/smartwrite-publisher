...
- [x] Parser extrai título de nota com/sem frontmatter
- [x] Conversor gera HTML válido para nota simples e callouts
- [x] API cria draft no Substack com título correto e recupera ID via fallback
